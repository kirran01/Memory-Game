...
const Card = ({ card, cards, setCards, setCount, victory }) => {
    ...
    return (
        <div onClick={() => flipCard()} className={`${card.isMatched || victory===false? 'bg-transparent border-none' : 'bg-white border-indigo-100 border-8 border-double shadow-md'} flex justify-center m-5 rounded-md w-60 cursor-pointer`}>
